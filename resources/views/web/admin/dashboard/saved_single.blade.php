...
<head>
    ...
    <title>Saved Listings | HomeCycle Admin</title>
...
<div class="wrap">
    <aside class="aside">
        ...
        <nav class="nav">
            ...
            <a class="active" href="{{ route('admin.saved') }}">Saved <span>→</span></a>
        </nav>
    ...
    <div class="main">
        <header class="top">
            <div class="topin">
                <h1 class="ttl">Saved Listings</h1>
        ...
        <main class="content">
            <div class="panel">
                ...
                <p class="p">This section will show which products users save the most. We can expand it into a full analytics report.</p>
                <div class="panel" style="box-shadow:none;margin-top:14px;">
                    <div class="k">Tip</div>
                    <p class="p">If you want, I can implement “Most saved listings” and “Top savers” rankings here using the existing <code>saved_listings</code> table.</p>
                </div>
            </div>
        </main>
    </div>
