...
<head>
    ...
    <title>Orders | HomeCycle Admin</title>
...
<div class="wrap">
    <aside class="aside">
        ...
        <nav class="nav">
            ...
            <a class="active" href="{{ route('admin.orders') }}">Orders <span>→</span></a>
    ...
    <div class="main">
        ...
        <main class="content">
            <div class="panel">
                ...
                <p class="p">This is a placeholder for an Orders module. When you introduce an orders table, we can list orders, payment status, customer info, and fulfillment here.</p>
                <div class="panel" style="box-shadow:none;margin-top:14px;">
                    <div class="k">Next step</div>
                    <p class="p">Add an orders table (or tell me your schema) and I’ll connect this page to real data.</p>
                </div>
            </div>
        </main>
    </div>
