...
<head>
    ...
    <title>Sales | HomeCycle Admin</title>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .v{margin-top:8px;font-weight:950;font-size:24px}
...
<div class="wrap">
    <aside class="aside">
        ...
        <nav class="nav">
            ...
            <a class="active" href="{{ route('admin.sales') }}">Sales <span>→</span></a>
    ...
    <div class="main">
        ...
        <main class="content">
            <div class="panel">
                ...
                <p class="p">This page is ready for your sales module. When you add Orders/Sales tables, we can wire real revenue charts and customer breakdowns here.</p>
