                        ...
                        <div style="display:flex;flex-direction:column;gap:10px;margin-top:16px;">
                            @if($phone)
                                <a class="btn btn-primary" href="tel:{{ $phone }}">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.8 19.8 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.8 19.8 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.12.86.33 1.7.62 2.5a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.58-1.19a2 2 0 0 1 2.11-.45c.8.29 1.64.5 2.5.62A2 2 0 0 1 22 16.92z"/></svg>
                                    Call Us
                                </a>
                            @endif
                            @if($wa)
                                <a class="btn btn-outline" target="_blank" href="https://wa.me/{{ preg_replace('/\D+/', '', $wa) }}">
